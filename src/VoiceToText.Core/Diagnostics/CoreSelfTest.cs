...
/// <summary>
/// The portable half of the self-test battery: every check here touches only Core types,
/// so any platform head (Windows, Linux) can run them via its own CLI dispatch. UI checks
/// live in each head's SelfTest class.
/// </summary>
